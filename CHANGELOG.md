...
### Added
- **30-Day Free Trial**: Extended our free trial from 14 days to a full 30 days! All non-paying and new users automatically receive a fresh 30-day trial upon updating.
- **Pochi Send & Dual-Wallet Filtering**: Outbound Pochi transactions are now classified as Pochi Send, and internal Pochi Transfers appear seamlessly in both Personal M-PESA and Pochi la Biashara filtering chips.

### Improved
- **Onboarding Experience**: Redesigned onboarding illustrations with clean transparent backgrounds and adjusted layout spacing to prevent text overlap on the scroll indicators.
...
- **M-Shwari ↔ M-PESA Transfer Hardening**: Enhanced M-Shwari parser to support Lock Savings, flexible punctuation, and default 'Savings' category, while fully preserving custom user categories.
